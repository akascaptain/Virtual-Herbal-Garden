...
fontLoader.load('https://threejs.org/examples/fonts/helvetiker_regular.typeface.json', (font) => {
  // Array of lines
  const lines = ['This Plant is known as Money Plant','is a low-maintenance, fast-growing houseplant','Improve air quality'];
...
loader.load('./silver_splash_pothos.glb', (gltf) => {
