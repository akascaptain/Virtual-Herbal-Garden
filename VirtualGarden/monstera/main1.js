...
fontLoader.load('https://threejs.org/examples/fonts/helvetiker_regular.typeface.json', (font) => {
  // Array of lines
  const lines = ['Monstera symbolizes prosperity,', 'purifies indoor air and enhances mental,', 'well-being through a soothing, natural presence'];
