...
fontLoader.load('https://threejs.org/examples/fonts/helvetiker_regular.typeface.json', (font) => {
  // Array of lines
  const lines = ['Palm plants aid digestion,','boost energy, cool the body, and support','heart and reproductive health.'];
...
loader.load('./house_palm_plant.glb', (gltf) => {
