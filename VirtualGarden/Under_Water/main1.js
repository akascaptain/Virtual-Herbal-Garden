...
fontLoader.load('https://threejs.org/examples/fonts/helvetiker_regular.typeface.json', (font) => {
  // Array of lines
  const lines = ['Underwater Ayurvedic plants like Brahmi ','and Punarnava support memory, reduce ','inflammation & detoxify kidney and liver health naturally.'];
...
loader.load('./underwater_plant_pack.glb', (gltf) => {
